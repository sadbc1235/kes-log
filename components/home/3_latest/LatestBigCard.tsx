...
export default function LatestBigCard({postInfo}:{postInfo:any}) {
    return (
        <div 
            className="h-[700px] rounded-xl overflow-hidden max-md:h-[500px] max-sm:h-[500px] hover:scale-[1.02] transition-transform duration-300 cursor-pointer" 
        ...
        >
            ...
            >
                ...
                <h2 className='text-lg font-bold line-clamp-1 text-ellipsis break-all max-md:text-base'>
                    {postInfo.title}
                </h2>
                <p className='text-sm/6 mt-4 text-wrap whitespace-pre break-all text-ellipsis line-clamp-[8] max-md:line-clamp-[5] max-md:text-xs/5'>
                    {postInfo.content}
                </p>
