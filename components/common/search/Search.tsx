...
export default function Search() {
  return (
    <div
        className="
          relative z-10 w-1/3 h-[60px] bg-[#fff] rounded-full border-[5px] border-[#1562e080] flex items-center pl-2 pr-3 overflow-hidden 
          max-xl:w-1/2 max-sm:w-3/4 max-sm:h-[50px] max-sm:border-[4px]
        "
    >
